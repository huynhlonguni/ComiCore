...
#define RL_TRUE         0x1
#define RL_FALSE        0x0
#define RL_KEEP         0x1e00
#define RL_REPLACE      0x1e01
#define RL_INCR         0x1e02
#define RL_INCR_WRAP    0x8507
#define RL_DECR         0x1e03
#define RL_DECR_WRAP    0x8508
#define RL_INVERT       0x150a
#define RL_NEVER        0x200 
#define RL_LESS         0x201
#define RL_LEQUAL       0x203
#define RL_GREATER      0x204
#define RL_GEQUAL       0x206
#define RL_EQUAL        0x202
#define RL_NOTEQUAL     0x205
#define RL_ALWAYS       0x207
...
RLAPI void rlEnableStencilMask(void);                           // Enable stencil write
RLAPI void rlDisableStencilMask(void);                          // Disable stencil write
RLAPI void rlStencilMask(unsigned int mask);                    // Change stencil write
RLAPI void rlStencilFunc(int func, int ref, unsigned int mask); // Stencil Function
RLAPI void rlStencilOp(int sfail, int dpfail, int dppass);      // Stencil Option
...
void rlEnableStencilMask(void) { glStencilMask(0xFF); }

// Disable stencil write
void rlDisableStencilMask(void) { glStencilMask(0x00); }

// Change stencil write
